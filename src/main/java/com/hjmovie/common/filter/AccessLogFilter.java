package com.hjmovie.common.filter;
...
public class AccessLogFilter implements Filter {
    ...
    private boolean doFilterEnable(ServletRequest servletRequest) {
        ...
        // 过滤掉swagger
        final String filterUrl1 = "swagger";
        final String filterUrl2 = "csrf";
        final String filterUrl3 = "api-docs";
        if (url.contains(filterUrl1) || url.contains(filterUrl2) || url.contains(filterUrl3)) {
            return false;
        }
        ...
        return HttpMethod.POST.toString().equals(method) || HttpMethod.PUT.toString().equals(method)
